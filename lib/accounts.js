...
exports.parseDoc = function (doc) {
    ...
    doc.name = doc['$hoodie_name'];
    doc.type = doc['$hoodie_type'];
...
exports.prepareDoc = function (doc) {
    ...
    // prepare CouchDB id
    properties._id = exports.convertID(properties.type, properties.name);
    delete properties.id;

    properties['$hoodie_name'] = properties.name;
    ...
    properties['$hoodie_type'] = properties.type;
