...
module.exports = function (options, callback) {
    ...
    api.databases = {
        ...
        info: function (name, callback) {
            console.log(['info', dbURL(name)]);
            Pouch(dbURL(name), function (err, db) {
                if (err) {
                    return callback(err);
                }
                db.info(utils.wrapPouchCallback(callback));
            });
        },
    ...
    api.users = {
        info: function (callback) {
            return api.databases.info(options.users_db, callback);
        },
        ...
        changes: function (opt, callback) {
            return api.docs.changes(options.users_db, opt, callback);
        }
    };
